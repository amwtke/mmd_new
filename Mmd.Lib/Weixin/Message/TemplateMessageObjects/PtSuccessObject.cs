...
{
    [Serializable]
    public class PtSuccessObject : TemplateBase
    {
        public PtSuccessObject(MessageBase first, MessageBase remark, MessageBase key1, MessageBase key2,MessageBase key3)
            : base(first, remark)
        {
            keyword1 = key1;
            keyword2 = key2;
