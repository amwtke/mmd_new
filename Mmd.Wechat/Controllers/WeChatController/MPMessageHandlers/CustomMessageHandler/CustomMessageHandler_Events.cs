...
namespace MD.Wechat.CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler 
    {
        private string GetWelcomeInfo()
        {
            ...
            return "只为愿意积极拥抱互联网的化妆品店服务，前方高能预警，非相关人员请迅速撤离！！！";
        }
        ...
        {
            bool updateOK = LocationManager.AddOrUpdateLocation(requestMessage.FromUserName, requestMessage.Latitude, requestMessage.Longitude);
            ...
            if(updateOK)
                MDLogger.LogInfo(typeof(CustomMessageHandler),$"更新了openid={requestMessage.FromUserName} 的位置信息！");
            return null;
        }
        ...
        public override IResponseMessageBase OnEvent_UnsubscribeRequest(RequestMessageEvent_Unsubscribe requestMessage)
        {
            ...
            string openid = requestMessage.FromUserName;
            string mp_id = requestMessage.ToUserName;
            RedisUserOp.DeleteOpenidAsync(openid);
            using (BizRepository rep = new BizRepository())
            {
                Merchant mer = rep.GetMerchantByMpId(mp_id);
                if (mer != null)
