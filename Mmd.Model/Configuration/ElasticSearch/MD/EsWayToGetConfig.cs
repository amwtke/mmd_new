...
{
    [MDConfig("ElasticSearch", "WriteOffPoint")]
    public class EsWriteOffPointConfig : IESIndexInterface
    {
        [MDKey("IndexName")]
    ...
    [MDConfig("ElasticSearch", "WriteOffer")]
    public class EsWriteOfferConfig : IESIndexInterface
    {
        [MDKey("IndexName")]
        public string IndexName { get; set; }
