...
namespace Senparc.Weixin.HttpUtility
{
    public static class Get
    {
        ...
        public static Stream DownloadImage(string url)
        {
            ...
            {
                string fileFlag = data[0].ToString() + data[1].ToString();
                List<string> strlist = new List<string>() { "255216", "7173", "6677", "13780" };//对应的图片格式jpg,gif,bmp,png
                if (strlist.Contains(fileFlag))
                {
