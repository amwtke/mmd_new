...
namespace Senparc.Weixin.MP.CommonAPIs
{
    public partial class CommonApi
    {
        ...
        public static async Task<WxJsonResult> CreateMenuAsync(string at, object buttonData, int timeOut = Config.TIME_OUT)
        {

                var urlFormat = "https://api.weixin.qq.com/cgi-bin/menu/create?access_token={0}";

                return await CommonJsonSend.SendAsync<WxJsonResult>(at, urlFormat, buttonData, timeOut: timeOut);
        }
